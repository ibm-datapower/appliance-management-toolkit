...
public class SOAPHelperFactory extends AbstractFactory {
     ...
     *         throws an exception.
     */
    public static SOAPHelper getSOAPHelper(String implementationClassName) throws SOMAException {
        ...
        try {
        	...
        	String message = Messages.getString("wamt.soma.SOAPHelperFactory.instClass",implementationClassName);
            SOMAException e = new SOMAException(message, caught,"wamt.soma.SOAPHelperFactory.instClass",implementationClassName); //$NON-NLS-1$
