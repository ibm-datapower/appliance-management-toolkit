 ...
 * AMP is the Appliance Management Protocol. For more information regarding the
 ...
 * <p>
 * 
 * @version SCM ID: $Id: AMPIOException.java,v 1.2 2010/08/23 21:20:27 burket Exp $
 */
// * Created on Aug 29, 2006
public class AMPIOException extends AMPException {
     ...
     * 
     * @see #AMPIOException(String)
     * @see #AMPIOException(Throwable)
     * @see #AMPIOException(String, Throwable)
     */
    public AMPIOException() {
        super();
    }
     ...
     * @see #AMPIOException(String, Throwable)
     */
    public AMPIOException(String message) {
        super(message);
    }
     ...
     *        msgKey
     */
    public AMPIOException(String message, String msgKey, Object[] msgParms) {
     ...
     */
    public AMPIOException(String message, String msgKey, Object msgParm) {
     ...
     *        used with the exception.
     */
    public AMPIOException(String message, String msgKey) {
     ...
     * @see #AMPIOException(Throwable)
     */
    public AMPIOException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     *        msgKey
     */
    public AMPIOException(String message, Throwable cause, String msgKey, Object[] msgParms) {
     ...
     */
    public AMPIOException(String message, Throwable cause, String msgKey, Object msgParm) {
     ...
     *        used with the exception.
     */
    public AMPIOException(String message, Throwable cause, String msgKey) {
     ...
     * @see #AMPIOException(String, Throwable)
     */
    public AMPIOException(Throwable cause) {
        super(cause);
    }
