...
/**
 * The NotificationCatcher encountered a problem while trying to acquire 
 * sufficient resources to start itself. For example, the NotificationCatcher
 * cannot acquire the listening socket where it wants AMP events (Notifications)
 * to be posted. See the message and cause for the details of this exception.
 * 
 */
public class NotificationCatcherResourceException extends AMPException {
     ...
     * 
     * @see #NotificationCatcherResourceException(String)
     * @see #NotificationCatcherResourceException(Throwable)
     * @see #NotificationCatcherResourceException(String, Throwable)
     */
    public NotificationCatcherResourceException() {
        super();
    }
     ...
     * @see #NotificationCatcherResourceException(String, Throwable)
     */
    public NotificationCatcherResourceException(String message) {
        super(message);
    }
     ...
     *        msgKey
     */
    public NotificationCatcherResourceException(String message, String msgKey, Object[] msgParms) {
     ...
     */
    public NotificationCatcherResourceException(String message, String msgKey, Object msgParm) {
     ...
     *        used with the exception.
     */
    public NotificationCatcherResourceException(String message, String msgKey) {
     ...
     * @see #NotificationCatcherResourceException(Throwable)
     */
    public NotificationCatcherResourceException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     *        msgKey
     */
    public NotificationCatcherResourceException(String message, Throwable cause, String msgKey, Object[] msgParms) {
     ...
     */
    public NotificationCatcherResourceException(String message, Throwable cause, String msgKey, Object msgParm) {
     ...
     *        used with the exception.
     */
    public NotificationCatcherResourceException(String message, Throwable cause, String msgKey) {
     ...
     * @see #NotificationCatcherResourceException(String, Throwable)
     */
    public NotificationCatcherResourceException(Throwable cause) {
        super(cause);
    }
