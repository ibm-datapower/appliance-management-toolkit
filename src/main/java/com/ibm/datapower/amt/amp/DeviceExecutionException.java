...
/**
 * The device had an internal error while executing an AMP command. That
 * internal device error is not described via the other exceptions thrown by the
 * invoking method. For more information regarding the problem, please refer to
 * this object's method {@link Throwable#getMessage() getMessage()}. The caller
 * who instantiates this object should attempt to put any information from the
 * device regarding its error into the <code>message</code> member of this
 * class.
 * <p>
 * @version SCM ID: $Id: DeviceExecutionException.java,v 1.2 2010/08/23 21:20:27 burket Exp $
 */
//* <p>
public class DeviceExecutionException extends AMPException {
     ...
     * 
     * @see #DeviceExecutionException(String)
     * @see #DeviceExecutionException(Throwable)
     * @see #DeviceExecutionException(String, Throwable)
     */
    public DeviceExecutionException() {
        super();
    }
    ...
    public DeviceExecutionException(String message, String msgKey, Object[] msgParms) {
     ...
     */
    public DeviceExecutionException(String message, String msgKey, Object msgParm) {
     ...
     *        used with the exception.
     */
    public DeviceExecutionException(String message, String msgKey) {
     ...
     * @see #DeviceExecutionException(Throwable)
     */
    public DeviceExecutionException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     *        msgKey
     */
    public DeviceExecutionException(String message, Throwable cause, String msgKey, Object[] msgParms) {
     ...
     */
    public DeviceExecutionException(String message, Throwable cause, String msgKey, Object msgParm) {
     ...
     *        used with the exception.
     */
    public DeviceExecutionException(String message, Throwable cause, String msgKey) {
     ...
     * @see #DeviceExecutionException(String, Throwable)
     */
    public DeviceExecutionException(Throwable cause) {
        super(cause);
    }
