...
/**
 * The requested item does not exist in the device. The requested item may be a
 * domain name or a subscription id.
 * <p>
 ...
 */
//* <p>
public class NotExistException extends AMPException {
     ...
     * 
     * @see #NotExistException(String)
     * @see #NotExistException(Throwable)
     * @see #NotExistException(String, Throwable)
     */
