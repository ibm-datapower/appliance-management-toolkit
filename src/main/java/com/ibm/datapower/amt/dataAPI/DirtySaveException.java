...
/**
 * This exception is thrown if an attempt is made to save data after
 * another user has made changes which will not be reflected in the saved repository.
 * In other words, the save would overlay another caller's changes.
 * <p>
 * @see DMgrException
 * @see com.ibm.datapower.amt.dataAPI.Repository#save(boolean)
 *  
 */
public class DirtySaveException extends DatastoreException {
    ...
    public DirtySaveException() {
        super();
    }

    public DirtySaveException(String message) {
        super(message);
    }
     ...
     *        msgKey
     */
    public DirtySaveException(String message, String msgKey, Object[] msgParms) {
     ...
     */
    public DirtySaveException(String message, String msgKey, Object msgParm) {
     ...
     *        used with the exception.
     */
    public DirtySaveException(String message, String msgKey) {
        super(message,msgKey);
    }

    public DirtySaveException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     *        msgKey
     */
    public DirtySaveException(String message, Throwable cause, String msgKey, Object[] msgParms) {
     ...
     */
    public DirtySaveException(String message, Throwable cause, String msgKey, Object msgParm) {
     ...
     *        used with the exception.
     */
    public DirtySaveException(String message, Throwable cause, String msgKey) {
        super(message, cause, msgKey);
    }

    public DirtySaveException(Throwable cause) {
        super(cause);
    }
