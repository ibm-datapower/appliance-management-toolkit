...
public class PackageInfo extends AbstractPackageInfo {
	...
	private PackageInfo() {
		...
		this.add(AlreadyExistsInRepositoryException.class);
		this.add(DatastoreException.class);
		this.add(DirtySaveException.class);
		this.add(NotEmptyInRepositoryException.class);
		this.add(NotExistInRepositoryException.class);
		this.add(PackageInfo.class);
		this.add(Persistable.class);
		this.add(Repository.class);
		this.add(RepositoryFactory.class);
		this.add(StoredDeployableConfiguration.class);
		this.add(StoredDeployablePolicy.class);		
		this.add(StoredDeploymentPolicy.class);
		this.add(StoredDeploymentPolicyVersion.class);		
		this.add(StoredDevice.class);
		this.add(StoredDomain.class);
		this.add(StoredDomainVersion.class);
		this.add(StoredFirmware.class);
		this.add(StoredFirmwareVersion.class);
		this.add(StoredManagedSet.class);
		this.add(StoredVersion.class);
	}
