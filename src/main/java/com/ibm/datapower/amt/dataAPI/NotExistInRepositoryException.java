 ...
 * It extends @DMgrException.
 * <p>
 * @see DMgrException
 * 
 */
public class NotExistInRepositoryException extends DatastoreException {
     ...
     */
    public NotExistInRepositoryException() {
        super();
    }
    ...
    public NotExistInRepositoryException(String message) {
        super(message);
    }
     ...
     *        msgKey
     */
    public NotExistInRepositoryException(String message, String msgKey, Object[] msgParms) {
     ...
     */
    public NotExistInRepositoryException(String message, String msgKey, Object msgParm) {
     ...
     *        used with the exception.
     */
    public NotExistInRepositoryException(String message, String msgKey) {
        super(message,msgKey);
    }

    public NotExistInRepositoryException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     *        msgKey
     */
    public NotExistInRepositoryException(String message, Throwable cause, String msgKey, Object[] msgParms) {
     ...
     */
    public NotExistInRepositoryException(String message, Throwable cause, String msgKey, Object msgParm) {
     ...
     *        used with the exception.
     */
    public NotExistInRepositoryException(String message, Throwable cause, String msgKey) {
        super(message, cause, msgKey);
    }

    public NotExistInRepositoryException(Throwable cause) {
        super(cause);
    }
