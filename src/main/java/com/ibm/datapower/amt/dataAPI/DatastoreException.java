...
/**
 * This is the root class for exceptions that are thrown from the dataAPI
 * package. All other exception classes should be a subclass of this.
 * <p>
 * @see DMgrException
 * 
 */
public class DatastoreException extends DMgrException {
     ...
     *        msgKey
     */
    public DatastoreException(String message, String msgKey, Object[] msgParms) {
     ...
     */
    public DatastoreException(String message, String msgKey, Object msgParm) {
     ...
     *        used with the exception.
     */
    public DatastoreException(String message, String msgKey) {
     ...
     *        msgKey
     */
    public DatastoreException(String message, Throwable cause, String msgKey, Object[] msgParms) {
     ...
     */
    public DatastoreException(String message, Throwable cause, String msgKey, Object msgParm) {
     ...
     *        used with the exception.
     */
    public DatastoreException(String message, Throwable cause, String msgKey) {
