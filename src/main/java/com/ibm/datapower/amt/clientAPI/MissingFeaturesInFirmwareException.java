...
/**
 * An operation was attempted between a Firmware and a Device, but the Device is
 * licensed for features that the Firmware does not provide libraries for. The
 * operation failed. If the operation was allowed to complete, then it is
 * possible that the Device may end up missing libraries to run features that it
 * is licensed for. The user needs to attempt the operation on the Device with a
 * Firmware that provides all the libraries for the Device's licensed features.
 * <p>
 * 
 * @see com.ibm.datapower.amt.clientAPI.Firmware#isCompatibleWith(Device)
 * @version SCM ID: $Id: MissingFeaturesInFirmwareException.java,v 1.2 2010/08/23 21:20:27 burket Exp $
 */
//* Created on Sep 6, 2007
public class MissingFeaturesInFirmwareException extends IncompatibilityException {
     ...
     */
    public MissingFeaturesInFirmwareException() {
        super();
    }
     ...
     *        exception
     */
    public MissingFeaturesInFirmwareException(String message) {
        super(message);
    }
     ...
     *        msgKey
     */
    public MissingFeaturesInFirmwareException(String message, String msgKey,
            Object[] msgParms) {
     ...
     */
    public MissingFeaturesInFirmwareException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     *        level which is the cause for this higher-level exception.
     */
    public MissingFeaturesInFirmwareException(Throwable cause) {
        super(cause);
    }
