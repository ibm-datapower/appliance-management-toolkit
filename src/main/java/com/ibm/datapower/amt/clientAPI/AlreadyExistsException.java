...
/**
 * The specified operation would create a duplicate, and duplicates are not
 * allowed.
 * <p>
 * <p>
 * @version SCM ID: $Id: AlreadyExistsException.java,v 1.2 2010/08/23 21:20:27 burket Exp $
 */
public class AlreadyExistsException extends ClientAPIException {
     ...
     *        msgKey
     */
    public AlreadyExistsException(String message, String msgKey, Object[] msgParms) {
     ...
     */
    public AlreadyExistsException(String message, String msgKey, Object msgParm) {
     ...
     *        used with the exception.
     */
    public AlreadyExistsException(String message, String msgKey) {
     ...
     *        msgKey
     */
    public AlreadyExistsException(String message, Throwable cause, String msgKey, Object[] msgParms) {
     ...
     */
    public AlreadyExistsException(String message, Throwable cause, String msgKey, Object msgParm) {
     ...
     *        used with the exception.
     */
    public AlreadyExistsException(String message, Throwable cause, String msgKey) {
     ...
     * @param cause a reference to another exception that occurred at a lower
     *        level which is the cause for this higher-level exception.
     * @see #AlreadyExistsException(String)
     * @see #AlreadyExistsException(String, Throwable)
     */
