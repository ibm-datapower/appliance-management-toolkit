...
/**
 * The credential supplied does not pass the authentication and/or the authorization
 * tests.
 * <p>
 * <p>
 * @version SCM ID: $Id: InvalidCredentialException.java,v 1.2 2010/08/23 21:20:27 burket Exp $
 */
public class InvalidCredentialException extends ClientAPIException {
     ...
     *        msgKey
     */
    public InvalidCredentialException(String message, String msgKey, Object[] msgParms) {
     ...
     */
    public InvalidCredentialException(String message, String msgKey, Object msgParm) {
     ...
     *        used with the exception.
     */
    public InvalidCredentialException(String message, String msgKey) {
     ...
     *        msgKey
     */
    public InvalidCredentialException(String message, Throwable cause, String msgKey, Object[] msgParms) {
     ...
     */
    public InvalidCredentialException(String message, Throwable cause, String msgKey, Object msgParm) {
     ...
     *        used with the exception.
     */
    public InvalidCredentialException(String message, Throwable cause, String msgKey) {
