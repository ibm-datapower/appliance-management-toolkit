...
/**
 * An operation was attempted with a Firmware and a Device, and the Firmware has
 * libraries for strict features that the Device is unlicensed for. The
 * operation failed. When the user is attempting to apply a Firmware to the
 * Device, the Firmware needs to not include any additional strict features.
 * <p>
 * 
 * @see com.ibm.datapower.amt.clientAPI.Firmware#isCompatibleWith(Device)
 * @version SCM ID: $Id: UnlicensedFeaturesInFirmwareException.java,v 1.2 2010/08/23 21:20:27 burket Exp $
 * <p>
 */
//* Created on Sep 6, 2007
public class UnlicensedFeaturesInFirmwareException extends IncompatibilityException {
     ...
     */
    public UnlicensedFeaturesInFirmwareException() {
        super();
    }
     ...
     *        exception
     */
    public UnlicensedFeaturesInFirmwareException(String message) {
        super(message);
    }
     ...
     *        msgKey
     */
    public UnlicensedFeaturesInFirmwareException(String message, String msgKey,
            Object[] msgParms) {
     ...
     */
    public UnlicensedFeaturesInFirmwareException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     *        level which is the cause for this higher-level exception.
     */
    public UnlicensedFeaturesInFirmwareException(Throwable cause) {
        super(cause);
    }
