...
/**
 * The requested item is locked by another thread and is unavailable for the
 * requested operation. The operation was not performed. Try again later, after
 * the other thread has released the lock. You can use
 * {@link com.ibm.datapower.amt.clientAPI.Lock#isAvailable()} to test for lock
 * availability, or just attempt to acquire the lock again and check for this
 * exception.
 * <p>
 * 
 * @version SCM ID: $Id: LockBusyException.java,v 1.2 2010/08/23 21:20:27 burket Exp $
 */
//* Created on Sep 12, 2006
public class LockBusyException extends ClientAPIException {
     ...
     *        msgKey
     */
    public LockBusyException(String message, String msgKey, Object[] msgParms) {
     ...
     */
    public LockBusyException(String message, String msgKey, Object msgParm) {
     ...
     *        used with the exception.
     */
    public LockBusyException(String message, String msgKey) {
     ...
     *        msgKey
     */
    public LockBusyException(String message, Throwable cause, String msgKey, Object[] msgParms) {
     ...
     */
    public LockBusyException(String message, Throwable cause, String msgKey, Object msgParm) {
     ...
     *        used with the exception.
     */
    public LockBusyException(String message, Throwable cause, String msgKey) {
