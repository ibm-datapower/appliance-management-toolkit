 ...
 * For more information, see {@link ManagedSet}
 * 
 * <p>
 * @version SCM ID: $Id: NotManagedException.java,v 1.2 2010/08/23 21:20:27 burket Exp $
 * <p>
 */
public class NotManagedException extends ClientAPIException {
     ...
     *        msgKey
     */
    public NotManagedException(String message, String msgKey, Object[] msgParms) {
     ...
     *            exception. This message should have already been localized for
     *            the jvm's locale, if possible.
     * @param msgKey
     *            a string giving the key of the NLS enabled message to be used
     *            with the exception.
     * @param msgParm
     *            an Object that gives the attributes to be used with msgKey
     */
    public NotManagedException(String message, String msgKey, Object msgParm) {
     ...
     *        used with the exception.
     */
    public NotManagedException(String message, String msgKey) {
     ...
     *        msgKey
     */
    public NotManagedException(String message, Throwable cause, String msgKey, Object[] msgParms) {
     ...
     */
    public NotManagedException(String message, Throwable cause, String msgKey, Object msgParm) {
     ...
     *        used with the exception.
     */
    public NotManagedException(String message, Throwable cause, String msgKey) {
     ...
     *        level which is the cause for this higher-level exception.
     */
    public NotManagedException(Throwable cause) {
        super(cause);
    }
