...
/**
 * An operation was attempted on two Device objects, and the two Devices did not
 * have the same licensed features. The operation failed. Generally this means
 * that one Device has a subset or superset of features of the other Device.
 * <p>
 * 
 * @version SCM ID: $Id: FeaturesNotEqualException.java,v 1.2 2010/08/23 21:20:27 burket Exp $
 */
public class FeaturesNotEqualException extends IncompatibilityException {
     ...
     */
    public FeaturesNotEqualException() {
        super();
    }
     ...
     *        exception
     */
    public FeaturesNotEqualException(String message) {
        super(message);
    }
     ...
     *        msgKey
     */
    public FeaturesNotEqualException(String message, String msgKey,
            Object[] msgParms) {
     ...
     */
    public FeaturesNotEqualException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     *        level which is the cause for this higher-level exception.
     */
    public FeaturesNotEqualException(Throwable cause) {
        super(cause);
    }
