 ...
 * More detailed information should be in the message/cause.
 * <p>
 * @version SCM ID: $Id: UnsuccessfulOperationException.java,v 1.2 2010/08/23 21:20:27 burket Exp $
 * <p>
 */
public class UnsuccessfulOperationException extends ClientAPIException {
     ...
     *        msgKey
     */
    public UnsuccessfulOperationException(String message, String msgKey, Object[] msgParms) {
     ...
     */
    public UnsuccessfulOperationException(String message, String msgKey, Object msgParm) {
     ...
     *        used with the exception.
     */
    public UnsuccessfulOperationException(String message, String msgKey) {
     ...
     *        msgKey
     */
    public UnsuccessfulOperationException(String message, Throwable cause, String msgKey, Object[] msgParms) {
     ...
     */
    public UnsuccessfulOperationException(String message, Throwable cause, String msgKey, Object msgParm) {
     ...
     *        used with the exception.
     */
    public UnsuccessfulOperationException(String message, Throwable cause, String msgKey) {
