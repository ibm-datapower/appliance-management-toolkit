 ...
 * <p>
 * @version SCM ID: $Id: NotExistException.java,v 1.2 2010/08/23 21:20:27 burket Exp $
 * <p>
 */
public class NotExistException extends ClientAPIException {
     ...
     *        msgKey
     */
    public NotExistException(String message, String msgKey, Object[] msgParms) {
     ...
     */
    public NotExistException(String message, String msgKey, Object msgParm) {
     ...
     *        used with the exception.
     */
    public NotExistException(String message, String msgKey) {
     ...
     *        msgKey
     */
    public NotExistException(String message, Throwable cause, String msgKey, Object[] msgParms) {
     ...
     */
    public NotExistException(String message, Throwable cause, String msgKey, Object msgParm) {
     ...
     *        used with the exception.
     */
    public NotExistException(String message, Throwable cause, String msgKey) {
