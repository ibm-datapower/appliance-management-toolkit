...
/**
 * The version you are trying to create, deploy or operate on is not supported and is not
 * allowed. The reason for the lack of support should be detailed in the
 * message field of this object.
 * <p>
 * @version SCM ID: $Id: UnsupportedVersionException.java,v 1.2 2010/08/23 21:20:27 burket Exp $
 * 
 */
public class UnsupportedVersionException extends ClientAPIException {
     ...
     *        msgKey
     */
    public UnsupportedVersionException(String message, String msgKey, Object[] msgParms) {
     ...
     */
    public UnsupportedVersionException(String message, String msgKey, Object msgParm) {
     ...
     *        used with the exception.
     */
    public UnsupportedVersionException(String message, String msgKey) {
     ...
     *        msgKey
     */
    public UnsupportedVersionException(String message, Throwable cause, String msgKey, Object[] msgParms) {
     ...
     */
    public UnsupportedVersionException(String message, Throwable cause, String msgKey, Object msgParm) {
     ...
     *        used with the exception.
     */
    public UnsupportedVersionException(String message, Throwable cause, String msgKey) {
