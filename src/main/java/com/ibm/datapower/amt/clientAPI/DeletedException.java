...
/**
 * The Java object you are trying to access has been deleted from the persisted
 * datastore. You should not be using this Java object. If you received a
 * reference to this object by iterating through a collection, please refresh
 * the collection. This object will likely not be present in the refreshed
 * collection.
 * <p>
 * 
 * @see Lock
 * @version SCM ID: $Id: DeletedException.java,v 1.2 2010/08/23 21:20:27 burket Exp $
 */
//* Created on Sep 12, 2006
//* <p>
public class DeletedException extends ClientAPIException {
     ...
     *        msgKey
     */
    public DeletedException(String message, String msgKey, Object[] msgParms) {
     ...
     */
    public DeletedException(String message, String msgKey, Object msgParm) {
     ...
     *        used with the exception.
     */
    public DeletedException(String message, String msgKey) {
     ...
     *        msgKey
     */
    public DeletedException(String message, Throwable cause, String msgKey, Object[] msgParms) {
     ...
     */
    public DeletedException(String message, Throwable cause, String msgKey, Object msgParm) {
     ...
     *        used with the exception.
     */
    public DeletedException(String message, Throwable cause, String msgKey) {
