...
/**
 * An operation was attempted on two objects, and the ModelType for the two
 * objects was incompatible. The operation failed. Generally the two objects are
 * Device/Firmware. Firmware can be applied only to Devices with matching DeviceType.
 * <p>
 * 
 * @see com.ibm.datapower.amt.ModelType
 * @see Firmware#isCompatibleWith(Device)
 * @version SCM ID: $Id: ModelTypeIncompatibilityException.java,v 1.2 2010/08/23 21:20:27 burket Exp $
 */
//* Created on Sep 6, 2007
public class ModelTypeIncompatibilityException extends IncompatibilityException {
     ...
     */
    public ModelTypeIncompatibilityException() {
        super();
    }
     ...
     *        exception
     */
    public ModelTypeIncompatibilityException(String message) {
        super(message);
    }
     ...
     *        msgKey
     */
    public ModelTypeIncompatibilityException(String message, String msgKey,
            Object[] msgParms) {
     ...
     */
    public ModelTypeIncompatibilityException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     *        level which is the cause for this higher-level exception.
     */
    public ModelTypeIncompatibilityException(Throwable cause) {
        super(cause);
    }
