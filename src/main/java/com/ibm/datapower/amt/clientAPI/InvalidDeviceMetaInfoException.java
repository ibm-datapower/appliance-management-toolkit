...
/**
 * The MetaInfo of the device that are being added to WAMT manager contains
 * some invalid values such as serial number.
 * <p>
 * 
 */
public class InvalidDeviceMetaInfoException extends ClientAPIException {
     ...
     */
    public InvalidDeviceMetaInfoException() {
        super();
    }
     ...
     *        exception
     */
    public InvalidDeviceMetaInfoException(String message) {
        super(message);
    }
     ...
     *        msgKey
     */
    public InvalidDeviceMetaInfoException(String message, String msgKey, Object[] msgParms) {
     ...
     */
    public InvalidDeviceMetaInfoException(String message, String msgKey, Object msgParm) {
     ...
     *        used with the exception.
     */
    public InvalidDeviceMetaInfoException(String message, String msgKey) {
     ...
     */
    public InvalidDeviceMetaInfoException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     *        msgKey
     */
    public InvalidDeviceMetaInfoException(String message, Throwable cause, String msgKey, Object[] msgParms) {
     ...
     */
    public InvalidDeviceMetaInfoException(String message, Throwable cause, String msgKey, Object msgParm) {
     ...
     *        used with the exception.
     */
    public InvalidDeviceMetaInfoException(String message, Throwable cause, String msgKey) {
     ...
     *        level which is the cause for this higher-level exception.
     */
    public InvalidDeviceMetaInfoException(Throwable cause) {
        super(cause);
    }
