...
/**
 * The specified {@link DomainVersion} 
 * is not deployable because it does not match the specified 
 * {@link DeploymentPolicyVersion}.
 * <p>
 * 
 * @see Manager#addFirmware(Blob, String)
 * @version SCM ID: $Id: UndeployableVersionException.java,v 1.2 2010/08/23 21:20:27 burket Exp $
 * <p>
 */
//* Created on Sep 14, 2006
public class UndeployableVersionException extends ClientAPIException {
     ...
     * 
     * @see #UndeployableVersionException(String)
     * @see #UndeployableVersionException(Throwable)
     * @see #UndeployableVersionException(String, Throwable)
     */
    public UndeployableVersionException() {
        super();
    }
     ...
     * @see #UndeployableVersionException(String, Throwable)
     */
    public UndeployableVersionException(String message) {
        super(message);
    }
     ...
     *        msgKey
     */
    public UndeployableVersionException(String message, String msgKey, Object[] msgParms) {
     ...
     */
    public UndeployableVersionException(String message, String msgKey, Object msgParm) {
     ...
     *        used with the exception.
     */
    public UndeployableVersionException(String message, String msgKey) {
     ...
     * @see #UndeployableVersionException(Throwable)
     */
    public UndeployableVersionException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     *        msgKey
     */
    public UndeployableVersionException(String message, Throwable cause, String msgKey, Object[] msgParms) {
     ...
     */
    public UndeployableVersionException(String message, Throwable cause, String msgKey, Object msgParm) {
     ...
     *        used with the exception.
     */
    public UndeployableVersionException(String message, Throwable cause, String msgKey) {
     ...
     * @see #UndeployableVersionException(String, Throwable)
     */
    public UndeployableVersionException(Throwable cause) {
        super(cause);
    }
